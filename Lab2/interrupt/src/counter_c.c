...
#define IRQ1 174	// Byt ut 0 mot IRQ för knapp som räknar upp // GPIO 8
#define IRQ2 175	// Byt ut 0 mot IRQ för knapp som räknar ner // GPIO 9
...
MODULE_AUTHOR("Max Karlson, Fredrik Olsson");
